    ...
    <el-main class="main-con">
      ...
      >
        ...
        <el-table-column
          ...
          width="80"
        ></el-table-column>
        <el-table-column prop="keydevice" label="日点检"></el-table-column>
        <el-table-column
          prop="kind"
          label="设备分类"
          width="80"
        ></el-table-column>
        <el-table-column prop="fixnumber" label="周保养"></el-table-column>
        <el-table-column prop="fixnumber" label="月保养"></el-table-column>
        <el-table-column
          prop="fixnumber"
          label="季度保养"
          width="80"
